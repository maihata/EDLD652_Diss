...
```{r}
us_data_wide <- read_csv("/Users/maiko/Desktop/EDLD652_Diss/Data/us_data_wide.csv")
```
...
```{r}
oregon_data_wide_DQ <- read_csv("/Users/maiko/Desktop/EDLD652_Diss/Data/oregon_data_wide_DQ.csv")
```
...
```{r}
race_us_chart <- read_csv("/Users/maiko/Desktop/EDLD652_Diss/Data/cc_transposed.csv")
```
...
```{r}
race_us_chart <- read_csv("/Users/maiko/Desktop/EDLD652_Diss/Data/childcount1920USOR_long.csv")
```
...
```{r}
residuals_df <- read.csv("/Users/maiko/Desktop/EDLD652_Diss/Data/residuals_df.csv
```
