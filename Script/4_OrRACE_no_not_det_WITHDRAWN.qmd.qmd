...
write.csv(
  ...
  "/Users/maiko/Desktop/EDLD652_Diss/Data/odds_withdrawn_oregon.csv",
  row.names = FALSE
)
...
```{r}
# 11/1/25 - added to drop the Oregon Average from the df/ggplot
summary_df_odds_withdrawn_plot <- summary_df_odds_withdrawn %>%
  filter(Race != "Oregon Average")
...
write.csv(
  ...
  "/Users/maiko/Desktop/EDLD652_Diss/Data/basic_table_withdrawn.csv",
  row.names = FALSE
)
```
...
write.csv(
  ...
  file = "/Users/maiko/Desktop/EDLD652_Diss/Data/cohens_h_withdrawn_by_race_OR.csv",
  row.names = FALSE
)
