...
bylang <- import("/Users/maiko/Desktop/EDLD652_Diss/Data/ODE data v3.xlsx") %>% 
  clean_names() %>% 
  select(-6) %>%
...
write.csv(agg_by_lang, 
          file =  "/Users/maiko/Desktop/EDLD652_Diss/Data/agg_by_lang.csv", 
          row.names = FALSE)
```
...
write.csv(
  agg_by_lang_3group,
  "/Users/maiko/Desktop/EDLD652_Diss/Data/agg_by_lang_3group.csv",
  row.names = FALSE
)
```
...
write.csv(
  stdres_lang_3group,
  file = "/Users/maiko/Desktop/EDLD652_Diss/Data/stdres_lang_3group.csv",
  row.names = FALSE
)
...
#   file = "/Users/maiko/Desktop/EDLD652_Diss/Data/cohenh_summary_lang3.csv",
#   row.names = FALSE
# )
...
# Step 1: Read the CSV
lang_df <- read_csv("/Users/maiko/Desktop/EDLD652_Diss/Data/agg_by_lang_formatted_by_row.csv")
...
lang_df <- read_csv("/Users/maiko/Desktop/EDLD652_Diss/Data/agg_by_lang_3group_formatted_by_row.csv")
