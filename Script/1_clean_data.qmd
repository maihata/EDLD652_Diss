...
write.csv(agg_by_race_and_state, 
          file = "Data/agg_by_race_and_state.csv", 
          row.names = FALSE)
```
...
```{r}
write.csv(race_oregon, file = "Data/race_oregon.csv", 
          row.names = FALSE)
```
...
```{r}
write.csv(race_us, file = "Data/race_us.csv", 
          row.names = FALSE)
```
...
```{r}
write.csv(race_us_chart, file = "Data/race_us_chart.csv", 
          row.names = FALSE)
```
...
```{r}
write.csv(race_oregon_chart, file = "Data/race_oregon_chart.csv", 
          row.names = FALSE)
```
