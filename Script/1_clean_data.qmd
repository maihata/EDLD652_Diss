...
```{r}
exit_categories <- import("/Users/maiko/Desktop/EDLD652_Diss/Data/exit_categories.xlsx") %>%
 clean_names() 
```

```{r}
write.csv(exit_categories, 
          file = "/Users/maiko/Desktop/EDLD652_Diss/Data/exit_categories.csv", 
          row.names = FALSE)
```
...
byrace <- import("/Users/maiko/Desktop/EDLD652_Diss/Data/race v.2.xlsx") %>% 
  clean_names() %>% 
  select(-7, -12) %>% 
  mutate(
...
```{r}
write.csv(byrace, 
          file = "/Users/maiko/Desktop/EDLD652_Diss/Data/byrace.csv", 
          row.names = FALSE)
```
...
```{r}
byrace_w_deceased_continuePartC <- import("/Users/maiko/Desktop/EDLD652_Diss/Data/race v.2.xlsx") %>% 
  clean_names() %>% 
  mutate(
    complete_or_not_eligible = 
      complete_prior_to_reaching_max_age_for_part_c + 
...
write.csv(byrace_w_deceased_continuePartC, 
          file = "/Users/maiko/Desktop/EDLD652_Diss/Data/byrace_w_deceased_continuePartC.csv", 
          row.names = FALSE)
```
...
write.csv(agg_by_race_and_state, 
          file = "/Users/maiko/Desktop/EDLD652_Diss/Data/agg_by_race_and_state.csv", 
          row.names = FALSE)
```
...
write.csv(race_oregon, 
          file = "/Users/maiko/Desktop/EDLD652_Diss/Data/race_oregon.csv", 
          row.names = FALSE)
```
...
```{r}
write.csv(race_us, 
          file = "/Users/maiko/Desktop/EDLD652_Diss/Data/race_us.csv", 
          row.names = FALSE)
```
...
write.csv(race_us_chart, 
          file = "/Users/maiko/Desktop/EDLD652_Diss/Data/race_us_chart.csv", 
          row.names = FALSE)
```
...
# us_race_chart <- read.csv("/Users/maiko/Desktop/EDLD652_Diss/Data/us_race_chart.csv", stringsAsFactors = FALSE)
...
write.csv(
  formatted_df,
  "/Users/maiko/Desktop/EDLD652_Diss/Data/us_race_chart_formatted_by_row.csv",
  row.names = FALSE
)
...
# us_race_chart <- read.csv("/Users/maiko/Desktop/EDLD652_Diss/Data/race_us_chart.csv", stringsAsFactors = FALSE)
```
...
# write.csv(formatted_df, "/Users/maiko/Desktop/EDLD652_Diss/Data/us_race_chart_formatted.csv", row.names = FALSE)
```
...
write.csv(race_oregon_chart, 
          file = "/Users/maiko/Desktop/EDLD652_Diss/Data/race_oregon_chart.csv", 
          row.names = FALSE)
```
...
```{r}
write.csv(area_by_race, file = "/Users/maiko/Desktop/EDLD652_Diss/Data/area_by_race.csv", 
          row.names = FALSE)
```
...
```{r}
write.csv(oregon_by_race, file = "/Users/maiko/Desktop/EDLD652_Diss/Data/oregon_by_race.csv", 
          row.names = FALSE)
```
...
```{r}
write.csv(us_data_long, file = "/Users/maiko/Desktop/EDLD652_Diss/Data/us_data_long.csv", 
          row.names = FALSE)
```
...
```{r}
write.csv(us_data_wide, file = "/Users/maiko/Desktop/EDLD652_Diss/Data/us_data_wide.csv", 
          row.names = FALSE)
```
...
```{r}
write.csv(agg_by_area, file = "/Users/maiko/Desktop/EDLD652_Diss/Data/agg_by_area.csv",
          row.names = FALSE)
```
...
```{r}
write.csv(data_oregon, file = "/Users/maiko/Desktop/EDLD652_Diss/Data/data_oregon.csv", row.names = FALSE)
```
...
```{r}
write.csv(data_national, file = "/Users/maiko/Desktop/EDLD652_Diss/Data/data_national.csv",row.names = FALSE)
```
...
```{r}
write.csv(us_data_attempts, file = "/Users/maiko/Desktop/EDLD652_Diss/Data/us_data_attempts.csv",row.names = FALSE)
```
...
```{r}
write.csv(us_data_attempts_BLWH, file = "/Users/maiko/Desktop/EDLD652_Diss/Data/us_data_attempts_BLWH.csv", 
          row.names = FALSE)
```
...
```{r}
write.csv(oregon_data_long, file = "/Users/maiko/Desktop/EDLD652_Diss/Data/oregon_data_long.csv", 
          row.names = FALSE)
```
...
```{r}
write.csv(oregon_data_wide, file = "/Users/maiko/Desktop/EDLD652_Diss/Data/oregon_data_wide.csv", 
          row.names = FALSE)
```
...
```{r}
write.csv(oregon_data_wide_DQ, file = "/Users/maiko/Desktop/EDLD652_Diss/Data/oregon_data_wide_DQ.csv")
```
...
```{r}
write.csv(us_data_DQ, file = "/Users/maiko/Desktop/EDLD652_Diss/Data/us_data_DQ.csv")
```
...
```{r}
write.csv(us_data_DQ_proportion_w_average, file = "/Users/maiko/Desktop/EDLD652_Diss/Data/us_data_DQ_proportion_w_average.csv")
```
