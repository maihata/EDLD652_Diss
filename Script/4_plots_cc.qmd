...
```{r}
cc_transposed <- read_csv("/Users/maiko/Desktop/EDLD652_Diss/Data/cc_transposed.csv")
```
...
```{r}
childcount1920USOR_long <- read_csv("/Users/maiko/Desktop/EDLD652_Diss/Data/childcount1920USOR_long.csv")
```
...
```{r}
write.csv(childcount1920USOR_long, file = "/Users/maiko/Desktop/EDLD652_Diss/Data/childcount1920USOR_long.csv",           row.names = FALSE)
