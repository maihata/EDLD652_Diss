...
```{r}
race_oregon <- read.csv("/Users/maiko/Desktop/EDLD652_Diss/Data/race_oregon.csv")
```
...
write.csv(race_oregon_w_average, 
            file="/Users/maiko/Desktop/EDLD652_Diss/Data/race_oregon_w_average.csv")
```
...
write.csv(race_oregon_w_average_full, 
          file="/Users/maiko/Desktop/EDLD652_Diss/Data/race_oregon_w_average_full.csv")
```
...
write.csv(race_oregon_w_WHITE, 
          file="/Users/maiko/Desktop/EDLD652_Diss/Data/race_oregon_w_WHITE.csv")
```
...
race_oregon_all_exits <- read.csv(
  "/Users/maiko/Desktop/EDLD652_Diss/Data/race_oregon.csv"
)
```
