...
```{r}
race_us_2 <- read_csv("/Users/maiko/Desktop/EDLD652_Diss/Data/race_us.csv")
```
...
write.csv(stdres_df_rounded, 
          file = "/Users/maiko/Desktop/EDLD652_Diss/Data/stdres_matrix_2.csv", 
          row.names = FALSE)
...
```{r}
write.csv(race_us_2, file = "/Users/maiko/Desktop/EDLD652_Diss/Data/race_us_2.csv", row.names = FALSE)
```
...
summary_df_odds_dismissed <- summary_df_odds_dismissed %>%
  mutate(Race = trimws(as.character(Race))) %>%
  filter(!Race %in% c("Race", "National Average"))
...
write.csv(
  summary_df_odds_dismissed,
  "/Users/maiko/Desktop/EDLD652_Diss/Data/summary_df_odds_dismissed_national.csv",
  row.names = FALSE
)
...
write.csv(
  summary_df_odds_dismissed,
  file = "/Users/maiko/Desktop/EDLD652_Diss/Data/summary_odds_dismissed_by_race.csv",
  row.names = FALSE
)
```
...
race_us_2_clean2 <- read.csv("/Users/maiko/Desktop/EDLD652_Diss/Data/race_us.csv")
...
write.csv(
  ...
  file = "/Users/maiko/Desktop/EDLD652_Diss/Data/cohens_h_dismissed_by_race.csv",
  row.names = FALSE
)
```
