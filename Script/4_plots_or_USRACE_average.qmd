...
us_data_DQ_proportion_w_average <- 
  read.csv("/Users/maiko/Desktop/EDLD652_Diss/Data/us_data_DQ_proportion_w_average.csv")
```
...
write.csv(us_race_3cols_8rows, 
          file="/Users/maiko/Desktop/EDLD652_Diss/Data/us_race_3cols_8rows.csv")
```
...
write.csv(us_race_odds_ratio_vs_average, 
          file="/Users/maiko/Desktop/EDLD652_Diss/Data/us_race_odds_ratio_vs_average.csv")
```
