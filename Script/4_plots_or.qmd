...
```{r}
write.csv(dq_native_us, file = "/Users/maiko/Desktop/EDLD652_Diss/Data/dq_native_us.csv", row.names = FALSE)
```
...
```{r}
write.csv(dq_hispanic_us, file = "/Users/maiko/Desktop/EDLD652_Diss/Data/dq_hispanic_us.csv", 
          row.names = FALSE)
```
